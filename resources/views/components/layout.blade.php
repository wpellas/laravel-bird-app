...
<html lang="en">
    ...
    <body>
        <header class="header-bar mb-3">
            <div class="container d-flex flex-column flex-md-row align-items-center p-3">
                <h4 class="my-0 mr-md-auto font-weight-normal"><a href="/" class="text-white">Not Twitter</a></h4>
    ...
    {{$slot}}
        ...
        <p class="m-0">Copyright &copy; {{date('Y')}} <a href="/" class="text-muted">Not Twitter</a>. All rights reserved.</p>
        </footer>
